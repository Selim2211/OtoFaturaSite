...
/* Hikaye aşama etiketleri — sahne kendi döngüsünden bildirir */
const STAGES = [
  '01 — KAĞIT FATURA',
  '02 — TARANIYOR',
  '03 — DİJİTALLEŞİYOR',
...
export default function Hero() {
  ...
  // Ekran dışına çıkınca R3F render döngüsü tamamen durur
  useEffect(() => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden bg-void">
      {/* 3D katmanı ya da mobil arka plan — hikaye kendi kendine sürekli döner */}
      <div className="absolute inset-0">
        {can3D ? (
          <Suspense fallback={<SceneLoader />}>
            <Scene3D quality={quality} active={heroVisible} onStage={setStage} />
          </Suspense>
        ) : (
          <HeroVisualLite />
        )}
      ...
      {/* Aşama göstergesi — sahnenin kendi döngüsünü izler (yalnızca masaüstü) */}
