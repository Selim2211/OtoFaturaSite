    ...
    <section className="py-24 px-6 bg-void relative overflow-hidden">
      ...
      >
        ...
        <div className="relative px-8 py-14 sm:px-16 text-center flex flex-col items-center gap-6">
          ...
          <p className="text-blue-50 max-w-md text-base leading-relaxed">
          ...
          <a
            ...
            className="group inline-flex items-center gap-3 bg-white text-brand-700 font-bold px-8 py-4 rounded-xl transition-all duration-200 shadow-lg hover:scale-[1.03] hover:bg-blue-50 text-base cursor-pointer"
          >
            <Download size={18} />
            Hemen İndir (Windows v1.0.4)
          ...
          <div className="mt-4 flex flex-col items-center gap-2 border-t border-white/20 pt-6 w-full max-w-md">
            ...
            <a
              href={`tel:${PHONE_TEL}`}
              className="font-data group inline-flex items-center gap-2.5 text-white font-extrabold text-2xl sm:text-3xl tracking-tight hover:text-blue-50 transition-colors"
            >
